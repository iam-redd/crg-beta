        ...
        <div className="mt-14 md:h-full sm:flex-wrap xl:flex xl:mx-auto xl:max-w-screen-xl 2xl:max-w-screen-2xl">
            ...
            <div>
                ...
                <div className='flex flex-col gap-2 mt-4'>
                    <p className='text-lg'> Для заказа, вам нужно авторизоваться или зарегистрироваться в личном кабинете.
                        <br/>
                ...
                <div className='flex flex-col gap-2 mt-4'>
                    {
                        userInfo.role === 'superUser' ?
                            ...
                            :
                            <p className='text-lg'>
                                Принимаем заказы с Понедельника по Субботу с 09:00 до 17:00. Доставка оплачивается по тарифу Yandex.Go - покупателем.
