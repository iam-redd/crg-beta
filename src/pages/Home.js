...
import deliveryIcon from '../assets/icons/delivery 1.svg'
            ...
            <div className='mt-10 bg-crg-opacity bg-no-repeat bg-white py-5'>
              ...
              <div className='flex w-full items-center'>
                ...
                <div className='flex w-3/5 mx-5'>
                  <p className='text-lg'>Наша компания в сфере HoReCa занимается поставками свежеобжаренного кофе и сиропов собственного производства.
              ...
              <div className='flex w-full items-center'>
                ...
                <div className='flex flex-col w-3/5 mx-5'>
                  ...
                  <p className='text-lg mt-5'>*Несколько видов Европейского обжарочного оборудования.
                  </p>
                  <p className='text-lg mt-5'>*Высокая стень очистки кофе дистонером. 3-х уровневый контроль качества.
                  </p>
              ...
              <div className='grid grid-cols-3 row-auto gap-10 items-center mt-10 xl:mx-auto xl:max-w-screen-xl 2xl:max-w-screen-2xl'>
              <div className='flex-col justify-center text-center items-center p-5'>
                <img src={deliveryIcon} alt='delivert' className='mx-auto my-5'/>
              ...
              <div className='flex-col justify-center text-center items-center p-5'>
                <img src={starIcon} alt='star' className='mx-auto my-5'/>
              ...
              <div className='flex-col justify-center text-center items-center p-5'>
                <img src={cupIcon} alt='cup' className='mx-auto my-5'/>
